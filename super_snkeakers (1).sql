...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 07, 2023 lúc 05:38 PM
...
CREATE TABLE `bill` (
  ...
  `hoten_nguoinhan` varchar(50) NOT NULL,
  `diachi_nguoinhan` varchar(50) NOT NULL,
  `dienthoai_nguoinhan` varchar(50) NOT NULL,
  `hoten_nguoidat` varchar(50) NOT NULL,
  `diachi_nguoidat` varchar(50) NOT NULL,
  `dienthoai_nguoidat` varchar(50) NOT NULL,
...
(6, 9, '', '', '', '', '', '', '', '0', '0', '0', '1', '0', 'SS9-173708-07122023');
...
(1, 'sang', '111', '', 'HCM', '0338071984', 'sangnguyen2004@gmail.com', 0),
(9, 'guest702', '123456', '', '', '', '', 0);
